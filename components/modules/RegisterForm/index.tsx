...
const RegisterFormComponent = () => {
  const isShowLeft = useFormUiStore((s) => s.isShowLeft);
  ...
  return (
    ...
    >
      ...
      {isShowLeft && (
        <div
          id="FORM__LEFT"
          className="flex xs:justify-center items-center-safe bg-nik-primary px-5 py-1 rounded-t-[10px] lg:rounded-l-2xl lg:rounded-tr-none w-full h-[190px] lg:h-full lg:basis-5/12"
        >
          <h2
            className={cn(
