const NumberSliderComponent = () => {
  return (
    <div id="RANGE__SLIDER" className="h-200 lg:h-180 w-full lg:w-[90%] mx-auto bg-[#f2f2f0]  lg:rounded-[30px] p-3.5 lg:p-6 flex items-center justify-center">
      <div className="bg-[#f2f2f0] overflow-hidden rounded-lg flex flex-col w-full justify-start  h-full gap-2.5 lg:gap-4">
        ...
        {/* BOTTOM SECTION */}
        <div id="FORM__WRAPPER" className="flex flex-col lg:flex-row items-center-safe gap-4 basis-11/12 rounded-lg bg-white lg:rounded-[30px]"></div>
      </div>
    </div>
  );
};
