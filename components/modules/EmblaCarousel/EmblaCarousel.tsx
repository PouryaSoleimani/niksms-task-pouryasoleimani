...
const EmblaCarousel: React.FC<PropType> = (props) => {
  ...
  return (
    <section className={cn("embla relative inset-0 w-full", !isMobile && "embla_mask")} dir="rtl">
      <div className="embla__viewport" ref={emblaRef}>
        <div className="embla__container mt-4 lg:mt-10 items-center justify-center-safe">
          {slides.map((slide: SlideItem) => (
            <div
              className="embla__slide flex-none basis-[78%] sm:basis-[70%] md:basis-[60%] lg:basis-[80%] h-46 xs:h-64 sm:h-80 lg:h-[365px] mx-auto lg:mx-1"
              key={slide.id}
            >
      ...
      {/*//^ CONTROLS */}
      <div className="scale-[0.4] xs:scale-50  -translate-y-2 xs:translate-y-1 sm:translate-y-1 md:-translate-y-1 lg:translate-y-1.5 sm:scale-[0.6] lg:scale-70 flex items-center-safe justify-center">
